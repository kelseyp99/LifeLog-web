...
export const ActivityLog: React.FC<ActivityLogProps> = ({ user }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: 32 }}>
      <h2 style={{ fontFamily: 'sans-serif', fontWeight: 700, fontSize: '2rem', marginBottom: 16, color: '#2d3748', letterSpacing: '0.03em' }}>ActivityLog Table</h2>
      {!user && <div style={{ color: 'salmon', marginBottom: 12 }}>Please sign in to view your activity logs.</div>}
      {loading ? <div style={{ marginBottom: 12 }}>Loading...</div> : null}
      <table style={{ borderCollapse: 'separate', borderSpacing: 0, minWidth: 520, background: '#fff', borderRadius: 12, boxShadow: '0 2px 16px rgba(0,0,0,0.08)', overflow: 'hidden', margin: '0 auto' }}>
        <thead>
